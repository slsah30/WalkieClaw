...
- `index.html`: all nine slides stacked; open it in a browser to preview.
...
```bash
npm i -g playwright   # or use an existing install; the script requires it from the global node_modules
