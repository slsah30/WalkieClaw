...
Requires Playwright with Chromium. `render.cjs` looks for the global Playwright install at `/opt/node22/lib/node_modules/playwright` and Chromium at `/opt/pw-browsers/chromium`; edit those two paths for your machine.
